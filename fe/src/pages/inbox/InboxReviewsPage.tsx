...
export default function InboxReviewsPage() {
  ...
  const supportedPlatforms = useMemo(
    () => PLATFORMS.filter((p) => (PLATFORMS_BY_TAB.reviews as readonly string[]).includes(p.key)),
    [],
  );

  const filteredAccounts = useMemo(() => {
    const supportedKeys = PLATFORMS_BY_TAB.reviews;
