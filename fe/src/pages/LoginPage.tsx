      ...
      <div className="flex items-center justify-center p-8 bg-brand-canvas">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight text-brand-ink mb-2">Welcome back!</h1>
            <p className="text-brand-body-mid text-sm">Please enter your details</p>
          </div>
          ...
          <div className="text-center text-sm text-brand-body-mid mt-8">
            ...
            <Link to="/signup" className="text-brand-ink font-medium hover:underline">Sign Up</Link>
          </div>
        </div>
      </div>
    </div>
