...
function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await authApi.register({ firstName, lastName, email, password, flow, plan });
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <button
        onClick={() => navigate('/')}
        className="fixed top-4 right-4 z-50 size-10 flex items-center justify-center rounded-full bg-brand-canvas border border-brand-border text-brand-body-mid hover:text-brand-ink hover:bg-brand-canvas-soft transition-colors"
      ...
      <div className="flex items-center justify-center p-8 bg-brand-canvas">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight text-brand-ink mb-2">Create your account</h1>
            <p className="text-brand-body-mid text-sm">Start managing your social media</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                />
                {fieldErrors.firstName && <span className="text-xs text-red-600 font-medium">{fieldErrors.firstName}</span>}
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                />
                {fieldErrors.lastName && <span className="text-xs text-red-600 font-medium">{fieldErrors.lastName}</span>}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-brand-body-mid hover:text-brand-ink transition-colors"
                >
            ...
            {error && (
              <div className="p-3 text-sm text-red-700 bg-red-50/50 border border-red-500/50 rounded-brand-md">{error}</div>
            )}
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full h-12 flex items-center justify-center gap-2 bg-brand-canvas border border-brand-border rounded-brand-md text-brand-ink text-base font-medium hover:bg-brand-canvas-soft transition-colors"
            >
