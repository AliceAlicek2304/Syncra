...
public sealed class UnlikeInboxCommentCommandHandler
    : IRequestHandler<UnlikeInboxCommentCommand, bool>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _zernioClient.UnlikeInboxCommentAsync(comment.ZernioPostId, comment.ZernioCommentId, comment.ZernioAccountId, request.LikeUri, cancellationToken);
    }
}
