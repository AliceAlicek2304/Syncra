...
public sealed class LikeInboxCommentCommandHandler
    : IRequestHandler<LikeInboxCommentCommand, bool>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _zernioClient.LikeInboxCommentAsync(comment.ZernioPostId, comment.ZernioCommentId, comment.ZernioAccountId, request.Cid, cancellationToken);
    }
}
