...
public sealed class HideInboxCommentCommandHandler
    : IRequestHandler<HideInboxCommentCommand, ZernioCommentActionResponseDto>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _zernioClient.HideInboxCommentAsync(post.ZernioPostId, post.ZernioTopCommentId, post.ZernioAccountId, cancellationToken);
    }
