...
public sealed class UnhideInboxCommentCommandHandler
    : IRequestHandler<UnhideInboxCommentCommand, bool>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _zernioClient.UnhideInboxCommentAsync(comment.ZernioPostId, comment.ZernioCommentId, comment.ZernioAccountId, cancellationToken);
    }
}
