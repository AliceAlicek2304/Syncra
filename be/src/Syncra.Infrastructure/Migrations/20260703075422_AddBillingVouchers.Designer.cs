...
namespace Syncra.Infrastructure.Migrations
{
    ...
    [Migration("20260703075422_AddBillingVouchers")]
    partial class AddBillingVouchers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Syncra.Domain.Entities.BillingPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("DiscountPercentOff")
                        .HasPrecision(5, 2)
                    ...
                    b.HasIndex("PaidAtUtc")
                        .HasDatabaseName("ix_billing_payments_paid_at_utc");
                    ...
                    b.HasIndex("WorkspaceId")
                        .HasDatabaseName("ix_billing_payments_workspace_id");
            ...
            modelBuilder.Entity("Syncra.Domain.Entities.BillingVoucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ApplicableIntervalsJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("applicable_intervals_json");

                    b.Property<string>("ApplicablePlanCodesJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("applicable_plan_codes_json");
                    ...
                    b.Property<int?>("MaxRedemptionsPerUser")
                        .HasColumnType("integer")
                        .HasColumnName("max_redemptions_per_user");
                    ...
                    b.Property<bool>("RequiresStudentVerification")
                        .HasColumnType("boolean")
                        .HasColumnName("requires_student_verification");
                    ...
                    b.HasIndex("ExpiresAtUtc")
                        .HasDatabaseName("ix_billing_vouchers_expires_at_utc");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("ix_billing_vouchers_is_active");

                    b.ToTable("billing_vouchers", (string)null);
                });

            modelBuilder.Entity("Syncra.Domain.Entities.BillingVoucherRedemption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("BillingPaymentId")
                        .HasColumnType("uuid")
                        .HasColumnName("billing_payment_id");
                    ...
                    b.HasIndex("RedeemedAtUtc")
                        .HasDatabaseName("ix_billing_voucher_redemptions_redeemed_at_utc");

                    b.HasIndex("SubscriptionId");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_billing_voucher_redemptions_user_id");

                    b.HasIndex("VoucherId")
                        .HasDatabaseName("ix_billing_voucher_redemptions_voucher_id");

                    b.HasIndex("WorkspaceId")
                        .HasDatabaseName("ix_billing_voucher_redemptions_workspace_id");

                    b.ToTable("billing_voucher_redemptions", (string)null);
                });
            ...
            modelBuilder.Entity("Syncra.Domain.Entities.BillingPayment", b =>
                {
                    ...
                    b.HasOne("Syncra.Domain.Entities.Subscription", "Subscription")
                        .WithMany()
            ...
            modelBuilder.Entity("Syncra.Domain.Entities.BillingVoucherRedemption", b =>
                {
                    b.HasOne("Syncra.Domain.Entities.BillingPayment", "BillingPayment")
                        .WithMany()
                    ...
                    b.HasOne("Syncra.Domain.Entities.BillingVoucher", "Voucher")
                        .WithMany()
